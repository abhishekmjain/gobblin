...
public class MysqlFlowSpecStoreWithTagFilterTest {
  private static final String USER = "testUser";
  private static final String PASSWORD = "testPassword";
  private static final String TABLE = "spec_store";
  private static final String TAG_FILTER = ",tag1";

  private ITestMetastoreDatabase testDb;
  private MysqlFlowSpecStoreWithTagFilter specStore;
  ...
  public MysqlFlowSpecStoreWithTagFilterTest()
  ...
  public void setUp() throws Exception {
    ...
    Config config = ConfigBuilder.create()
        ...
        .addPrimitive(ConfigurationKeys.FLOW_SPEC_TAG_FILTER_KEY, TAG_FILTER)
        .build();

    this.specStore = new MysqlFlowSpecStoreWithTagFilter(config, new TestSpecSerDe());
